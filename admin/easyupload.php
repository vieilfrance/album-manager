...
if (is_dir($repertoire."/easyupload")) // Test s'il s'agit d'un repertoire
	...
	while(false!==($file = readdir($dir)))
		{ //on lit tout et on recupere tous les fichiers dans $file 
		if (is_dir($repertoire."/easyupload/".$file) == false) // on filtre les repertoire - hack : il faut mettre le full path sinon le test ne fonctionne pas
		{
		echo "==>".$file;
